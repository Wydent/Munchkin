...
public class Partie {
    ...
    // test de ouffe : nouvelle HashMap d'enregistrement des joueurs
    ...
    public static ArrayList<String> piocher(int nombrecarte, String paquet,Joueur j){
